	...
	<div class="table">
		...
		<br>
			<form action='InserisciServlet' method='post'>
	        	...
	        	<br><br>
		        <input class="button" type="submit" value="Inserisci prodotto">
		    </form>
		</div>
	</div>
		...
		<form action='ModificaServlet' method='post'>
			...
			<table>
				...
				<tr>
					...
					<th>quantita'</th>
					<th>elimina</th>
					<th>varia<br>prezzo</th>
					<th>varia<br>quantita'</th>
				</tr>
			...
			%>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" class="number" name="cancellaCheck_<%= cont %>"></td>
                    <td><input type="number" name="newPrezzo_<%= cont %>" step="0.01" min="0"></td>
                    <td><input type="number" name="newQuantita_<%= cont %>" min="0"></td>
                </tr>
                
                <!-- Per ogni riga inviamo l'id prodotto come campo hidden. 
                	 Non verrà visualizzato dall'utente ma arriverà alla Servlet -->
                <input type="hidden" name="idProdotto_<%= cont %>" value="<%= prodotto.getID() %>">
			...
			<input class="button" type="submit" name="azione" value="Elimina selezionati">
			<input class="button" type="submit" name="azione" value="Aggiorna prezzo">
			<input class="button" type="submit" name="azione" value="Aggiorna quantita'">
