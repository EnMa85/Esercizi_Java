...
<body>
	...
	<div class="table">
		...
		<form action='ConfermaOrdineServlet' method='post'>
			...
			<ol>
				...
				<li><%= prodotto.getNome() %> - prezzo unitario € <%= String.format("%.2f", prodotto.getPrezzo()) %>
					- quantità' ordinata: <%= prodotto.getQuantita() %> <br> <br></li>
				<% } %>
			</ol>

			<p>
				<b>Totale ordine: € <%= String.format("%.2f", totaleOrdine) %></b>
			</p>
			<br> <input class="button" type="submit" value="Conferma ordine">
	...
	<div id="footer">
		<a href="javascript:window.history.back()"><button class="button"
				id="back">Torna indietro</button></a>
	</div>
