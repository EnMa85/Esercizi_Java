...
<html>
	...
	<body>
		...
		<div id="prod">
			<p>Seleziona i prodotti che vuoi ordinare o consulta il tuo <a href="StoricoOrdiniServlet">storico ordini</a></p>
					...
					<form action='OrdinaServlet' method='post'>
						...
						<table>
							<tr>
								<th>prodotto</th>
								<th>prezzo<br>€</th>
								<th>unità<br>disponibili</th>
								<th>quantità<br>ordine</th>
							</tr>
							...
							<tr>	
								...
								<td><input class="number" type="number" max="<%= prodotto.getQuantita() %>" min="1" name="quantita_<%= prodotto.getID() %>"></td>
							</tr>
							<% } %> 
