...
<body>
				...
				<c:forEach var="ordine" items="${ mappaOrdini }">
					<div id="storico">
						...
						<table id="storico">
							...
							<c:forEach var="dettaglio" items="${ ordine.dettaglio }"
								varStatus="loop">
								<tr>
									<td>${ loop.index + 1 }.${ dettaglio.nome_prodotto }</td>
									<td><fmt:formatNumber
											value="${ dettaglio.prezzo_prodotto }" type="currency"
											currencyCode="EUR" /></td>
	...
	<div id="footer">
		<a href="UtenteServlet"><button class="button" id="back">Torna
				alla home</button></a> <a href="LogoutServlet"><button class="button"
